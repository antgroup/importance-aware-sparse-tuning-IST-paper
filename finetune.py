...
def train(
    ...
    if model.config.model_type == "llama" and 'llama3' not in base_model:
    ...
    if use_ist:
        ...
        print('Importance-aware Sparse Tuning activated')
        ist_callback = ISTCallback(model, train_data.remove_columns(['instruction', 'answer', 'output', 'input']), data_collator)
